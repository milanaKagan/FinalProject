...
function delete_country_flights(id) {
        const f = async () => {
                if (id <= 0 || id == null) {
                        logger_repo.log({
                                level: 'error',
                                message: 'admin-dao: delete_country_flights function: id is invalid'
                            });
                        return -1;
                }
                else {
                        ...
                        logger_repo.log({
                                level: 'info',
                                message: `admin-dao: flight with ${id} was deleted ${result.rows[0].sp_delete_country_flights.toString()}`
                            });
...
function delete_customers_user(id) {
        ...
        const f = async () => {
                if (id <= 0 || id == null) {
                        logger_repo.log({
                                level: 'error',
                                message: 'admin-dao: delete_customers_user function: id is invalid'
                            });
                        return -1;
                }
                else {
                        ...
                        logger_repo.log({
                                level: 'info',
                                message: `admin-dao: customer with ${id} was deleted : ${result.rows[0].sp_delete_customers_user.toString()}`
                            });
...
function get_all_customers() {
        ...
        const f = async () => {
                ...
                logger_repo.log({
                        level: 'info',
                        message: `admin-dao: get all users request`
                    });
                return result.rows;
        }
        return try_func(f);
...
function get_all_tickets() {
        ...
        const f = async () => {
                ...
                logger_repo.log({
                        level: 'info',
                        message: `admin-dao: get all tickets request`
                    });
                return result.rows;
        }
        return try_func(f);
...
function insert_country(name) {
        ...
        const f = async () => {
                if (name == '' || name == null) {
                        logger_repo.log({
                                level: 'error',
                                message: 'admin-dao: insert_country function: name is null or empty'
                            });
                        return -1;
                }
                else {
                        ...
                        logger_repo.log({
                                level: 'info',
                                message: `admin-dao: insert country ${result.rows[0].sp_insert_country.toString()}`
                            });
...
function update_country(id, name) {
        ...
        const f = async () => {
                if (name == '' || name == null) {
                        logger_repo.log({
                                level: 'error',
                                message: 'admin-dao: update_country function: name is null or empty'
                            });
                        return -1;
                }
                if (id <= 0 || id == null) {
                        logger_repo.log({
                                level: 'error',
                                message: 'admin-dao: update_country function: id is invalid'
                            });
                        return -1;
                        ...
                        logger_repo.log({
                                level: 'info',
                                message: `admin-dao: country with id ${id} was updated : ${result.rows[0].sp_update_country.toString()}`
                            });
...
function insert_airline(name, countryId, userId) {
        ...
        const f = async () => {
                if (name == '' || name == null) {
                        logger_repo.log({
                                level: 'error',
                                message: 'admin-dao: insert_airline function: name is null or empty'
                            });
                        return -1;
                }
                if (countryId <= 0 || countryId == null) {
                        logger_repo.log({
                                level: 'error',
                                message: 'admin-dao: insert_airline function: countryId is invalid'
                            });
                        return -1;
                }
                if (userId <= 0 || userId == null) {
                        logger_repo.log({
                                level: 'error',
                                message: 'admin-dao: insert_airline function: userId is invalid'
                            });
                        return -1;
                }
                else {
                        ...
                        logger_repo.log({
                                level: 'info',
                                message: `admin-dao: airline with id ${result.rows[0].sp_insert_airline.toString()} was inserted`
                            });
...
function delete_airline_flights(id) {
        ...
        const f = async () => {
                if (id <= 0 || id == null) {
                        logger_repo.log({
                                level: 'error',
                                message: `admin-dao: delete_airline_flights function: id is invalid`
                            });
                        return -1;
                }
                else {
                        ...
                        logger_repo.log({
                                level: 'info',
                                message: `admin-dao: airline with id ${id} was deleted`
                            });
...
function get_user_by_id(id) {
        ...
        const f = async () => {
                if (id <= 0 || id == null) {
                        logger_repo.log({
                                level: 'error',
                                message: `admin-dao: get_user_by_id function: id is invalid`
                            });
                        return -1;
                }
                else {
                        ...
                        logger_repo.log({
                                level: 'info',
                                message: `admin-dao: get user by id ${id} request`
                            });
                        return result.rows;
                }
        }
